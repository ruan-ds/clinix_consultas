...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_patient_access_person_id'), table_name='patient_access')
    op.drop_table('patient_access')
    op.drop_index(op.f('ix_clinix_access_person_id'), table_name='clinix_access')
    op.drop_index(op.f('ix_clinix_access_email'), table_name='clinix_access')
    op.drop_table('clinix_access')
    op.drop_index(op.f('ix_clinical_access_person_id'), table_name='clinical_access')
    op.drop_index(op.f('ix_clinical_access_email'), table_name='clinical_access')
    ...
    op.drop_index(op.f('ix_clinic_cnpj'), table_name='clinic')

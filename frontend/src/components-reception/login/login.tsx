...
function Login({ changeAuth }: Props) {
  ...
  // TODO: integrar com endpoint real de autenticação da recepção quando o
  // back-end estiver pronto. Por enquanto, o login é simulado: qualquer
  // envio do formulário redireciona direto para a tela da recepção.
  ...
  return (
    <main className="login-container">
      ...
      <aside className="promo-card">
        <h2>Área da Recepção<br />Bom trabalho!</h2>
        <p>Acesse o fluxo do dia, cadastre<br />pacientes e agende consultas</p>
      </aside>
    </main>
  );
}

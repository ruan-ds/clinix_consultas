...
function Login({ changeAuth }: Props) {
  ...
  // TODO: integrar com endpoint real de autenticação do administrador Clinix
  // (BPO) quando o back-end estiver pronto. Por enquanto, o login é
  ...
  return (
    <main className="login-container">
      ...
      <aside className="promo-card">
        <h2>Área Administrativa<br />Bem-vindo de volta!</h2>
        <p>Gerencie clínicas, acessos e<br />operações da rede Clinix</p>
      </aside>
    </main>
  );
}
